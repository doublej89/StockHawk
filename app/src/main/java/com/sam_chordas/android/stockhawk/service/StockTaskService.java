...
public class StockTaskService extends GcmTaskService{
  ...
  public static final int STATUS_SERVER_DOWN = 10;
  public static final int STATUS_SERVER_INVALID = 11;
  public static final int STATUS_FAILED_TO_APPLY_BATCH_INSERT = 12;
  ...
  public int onRunTask(TaskParams params){
    ...
    if (params.getTag().equals("init") || params.getTag().equals("periodic")){
      ...
      mStockInput = params.getExtras().getString("symbol");
      try {
        urlStringBuilder.append(URLEncoder.encode("\""+mStockInput+"\")", "UTF-8"));
      } catch (UnsupportedEncodingException e){
        e.printStackTrace();
      }
    }
    ...
    if (urlStringBuilder != null){
      ...
      try{
        ...
        try {
          ...
          setLocationStatus(mContext, STATUS_SERVER_INVALID);
        }
      } catch (IOException e){
        e.printStackTrace();
  ...
  static private void setLocationStatus(Context c, int locationStatus){
    ...
    spe.putInt(c.getString(R.string.pref_status_key), locationStatus);
    spe.commit();
  }
