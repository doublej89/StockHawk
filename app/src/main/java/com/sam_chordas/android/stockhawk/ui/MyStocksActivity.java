...
//Implementations of updateEmptyView() and methods related to onSharedPreferenceChangeListener were influenced by
//similar implementations in the Sunshine weather app of the Advanced Android Development course
...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, SharedPreferences.OnSharedPreferenceChangeListener{
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    recyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
            new RecyclerViewItemClickListener.OnItemClickListener() {
              ...
              public void onItemClick(View v, int position) {
                ...
                intent.putExtra("quoteSymbol", symbol);
    ...
    fab.setContentDescription(getString(R.string.a11y_add_new_stock));
  ...
  private void updateEmptyView(){
    ...
    if (mCursorAdapter.getItemCount() == 0){
      TextView tv = (TextView) findViewById(R.id.recycler_empty_view);
      if (tv != null){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(this);
        int status_key =  sp.getInt(getString(R.string.pref_status_key), 0);
        if (status_key == StockTaskService.STATUS_SERVER_DOWN){
          tv.setText(R.string.empty_stock_list_server_down);
        }
        else if (status_key == StockTaskService.STATUS_SERVER_INVALID){
          tv.setText(R.string.empty_stock_list_server_error);
        }
        else if (!isConnected) {
          tv.setText(getString(R.string.network_toast));
        }
      }
    }
  }
